...
//
//
//extension CalendarWrapper:JTACMoJTACMonthViewDataSourceJTACMonthViewDelegate{
//
//    func calendar(_ calendar: JTACMonthVieJTACMonthView,:_ JTAppleCell, forItemAt date: Date, cellState: CellState, indexPath: IndexPath) {
//
//        let myCustomCell = cell as! CalendarCell
//        configureVisibleCell(myCustomCell: myCustomCell, cellState: cellState, date: date)
//    }
//
//    func handleCellConfiguration(cell: JTACDayCell?, _: cellJTACDayCellState) {
//
...
//    func handleCellSelection(view: JTACDayCell?, _: cellJTACDayCellState) {
//
...
//    func handleCellTextColor(view: JTACDayCell?, _: cellJTACDayCellState) {
//
...
//        }
//
//        if cellState.isSelected && cellState.dateBeCellState == .thisMonth {
//
//
...
//
//
//    func calendar(_ calendar: JTACMonthView, _: celJTACMonthViewte, cellState: CellState, indexPath: IndexPath) -> JTAppleCell {
//
...
//
//
//    func calendar(_ calendar: JTACMonthView, didSelectJTACMonthViewll: JTACDayCell?, cellState: CellSJTACDayCell){
//
...
//    }
//
//func calendar(_ calendar: JTAppleCalendarView, didDeselectDate date: Date, cell: JTACDayCell?, cellState: CellState) {
//
//        handleCellConfiguration(cell: cell, cellState: cellState)
//        return
//    }
