...
class PaymentSuccessRootView: ExtendedView {
    ...
    func initializeChatInfo(){
        ...
        if UIDevice.current.userInterfaceIdiom == .pad{
            ...
            let greenAttribute = [NSAttributedStringKey.foregroundColor: UIColor(hexString: AppThemeConfig.themeColor),NSAttributedStringKey.font:UIFont(name: "Poppins", size: 24)]
            
            let grayAttribute = [NSAttributedStringKey.foregroundColor: UIColor(hexString: "#B7B7B7"),NSAttributedStringKey.font:UIFont(name: "Questrial", size: 24)]
            ...
            let greenAttribute = [NSAttributedStringKey.foregroundColor: UIColor(hexString: AppThemeConfig.themeColor),NSAttributedStringKey.font:UIFont(name: "Poppins", size: 18)]
            
            let grayAttribute = [NSAttributedStringKey.foregroundColor: UIColor(hexString: "#B7B7B7"),NSAttributedStringKey.font:UIFont(name: "Questrial", size: 18)]
