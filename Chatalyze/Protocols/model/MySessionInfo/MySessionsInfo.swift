...
class MySessionsInfo: NSObject {
    ...
    var _time:String{
        ...
        set{
            ...
            self.endDate = DateParser.convertDateToDesiredFormat(date: _endDate, ItsDateFormat: "yyyy-MM-dd'T'HH:mm:ss.SSSZ", requiredDateFormat: Locale.current.languageCode == "en" ? "MMM dd, yyyy" : Locale.current.languageCode == "ko" ? "MM월 d일" : "dd/MM/yyyy")
