...
class MyTicketsVerticalController: MyTicketsController{
    ...
    func underLineLable(){
        ...
        if let underlineAttribute = [kCTUnderlineStyleAttributeName: NSUnderlineStyle.styleSingle.rawValue,NSAttributedStringKey.font:UIFont(name: "Questrial", size: fontSize)] as? [NSAttributedStringKey : Any]{
