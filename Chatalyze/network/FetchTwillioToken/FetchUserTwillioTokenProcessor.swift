//
//  FetchUserTwillioTokenProcessor.swift
//  Chatalyze
//
...
class FetchUserTwillioTokenProcessor {
    
  public func fetch(chatId:String?,slotId:Int?, completion : @escaping ((_ success : Bool, _ error : String,_ info:TwillioTokenInfo?)->())){
